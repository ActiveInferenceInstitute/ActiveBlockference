# Agent Guide — `library/repos/ActiveBlockference/tests/utils`

## Purpose

This folder is part of the instituteos tree at `library/repos/ActiveBlockference/tests/utils`. Read [`README.md`](README.md) for a short human-facing description.
